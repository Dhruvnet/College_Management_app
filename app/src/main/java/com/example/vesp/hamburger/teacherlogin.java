...
public class teacherlogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username_var = findViewById(R.id.teacheruname);
        pass_var = findViewById(R.id.teacherpassword);
        LoginBtn = findViewById(R.id.trloginBtn);
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (snapshot.exists()) {
                                    ...
                                    if (pass_check.equals(pass_data)) {
                                        ...
                                        SharedPreferences sharedPreferences = getSharedPreferences(teacherlogin.PREFS_NAME , MODE_PRIVATE);
                                        SharedPreferences.Editor editor = sharedPreferences.edit();
                                        editor.putBoolean("hasLoggedIn" ,true);
                                        editor.commit();

                                        startActivity(new Intent(teacherlogin.this , t1.class));
                                        finish();
